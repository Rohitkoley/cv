...
public class BookFlight extends JFrame implements ActionListener {
    JLabel tfname , tfnationality , tfadress , labelgender , labelfname , labelfcode;
    JTextField tfaadhar ;
    ...
    public BookFlight(){
       ...
       JLabel lbldest =new JLabel("Destination");
        ...
        flight.setBounds(380,380,120,21);
        ...
        ImageIcon image = new ImageIcon(ClassLoader.getSystemResource("AMS/iconss/bkf.jpg"));
        JLabel lblimage = new JLabel(image);
        lblimage.setBounds(0, 0 , 1100 , 700);
        add(lblimage);
